...
LOCAL thermometer IS SHIP:PARTSNAMED("sensorThermometer").

PRINT "Ground experiments".

LOCAL experiment IS command_pod:GETMODULE("ModuleScienceExperiment").

experiment:DEPLOY.
wait until experiment:HASDATA.

SET experiment TO thermometer[0]:GETMODULE("ModuleScienceExperiment").
...
thermometer[1]:GETMODULE("ModuleScienceExperiment"):DEPLOY.
